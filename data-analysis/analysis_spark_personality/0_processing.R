...
data_directory <- here("data-analysis","data","spark-personality","raw")
processed_data_directory <- here("data-analysis","data","spark-personality","processed")
file_name <- "emogo-spark-personality"
